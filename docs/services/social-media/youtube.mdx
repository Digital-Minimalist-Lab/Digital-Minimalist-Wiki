...
| ------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------- | ------------------------------------------------------------------- |
| [Feedless](#feedless)           | [Link](https://addons.mozilla.org/en-US/firefox/addon/feedless/)             |                                                                                   | [Github](https://github.com/ZMensRain/Feedless)       |                                                                     |
...
Feedless is an extension for removing feeds on many different platforms. It supports passwords to lock settings and can hide shortform content instead of outright blocking it so you can still view shortform content but cannot doomscroll.

### Actionable Steps

1. **Choose an extension**. Feedless is great and has everything you need to change the UI of Youtube to be less attention sucking.
2. **Set a password**. Open Feedless's options, it has a link in its popup, and set a password, this is to add back some friction.
3. **Test for a few days** see what works what doesn't and adjust accordingly.
4. **Turn off your watch history or signout of your google account** (Optional). The reasoning behind turning off watch is that Youtube restricts some addictive features, like the homepage and shorts.
