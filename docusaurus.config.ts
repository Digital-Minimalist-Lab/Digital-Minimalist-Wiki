...
const config: Config = {
  ...
  tagline: 'Tranquility in the digital age',
  ...
  url: 'https://digitalminimalism.wiki',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Digital-Minimalist-Lab/Digital-Minimalist-Wiki',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Discord',
              href: 'https://discord.com/invite/yfnUtNK8dg',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Digital Minimalist Lab. Built with Docusaurus.`,
    },
    prism: {
